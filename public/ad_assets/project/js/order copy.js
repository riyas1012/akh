...
$(document).ready(function() {
	...
	if(divRequest == 'add')  {
		...
		$("#createOrderForm").unbind('submit').bind('submit', function() {
			...
			// form validation 
			if(!venueType) {
				$("#venueCode").after('<p class="text-danger"> The Venue Type field is required </p>');
			...
			if(!venueName) {
				$("#venueName").after('<p class="text-danger"> The Client Name field is required </p>');
			...
			if(!lsCategory) {
				$("#lsc").after('<p class="text-danger"> The Contact field is required </p>');
			...
			if(!lsSubcat) {
				$("#lssub").after('<p class="text-danger"> The Paid field is required </p>');
			...
			if(!lsName) {
				$("#lsname").after('<p class="text-danger"> The Discount field is required </p>');
			...
			if(!lsCode) {
				$("#lscode").after('<p class="text-danger"> The Payment Type field is required </p>');
			...
			for (var x = 0; x < itemCat.length; x++) {       			
				...
				if(itemCat[x].value == ''){	    		    	
					$("#"+itemCatId+"").after('<p class="text-danger"> Product Name Field is required!! </p>');
		   ...
		   for (var x = 0; x < itemSubat.length; x++) {       			
				...
				if(itemSubat[x].value == ''){	    		    	
					$("#"+itemSubatId+"").after('<p class="text-danger"> Product Name Field is required!! </p>');
		   ...
		   for (var x = 0; x < itemName.length; x++) {       			
				...
				if(itemName[x].value == ''){	    		    	
					$("#"+itemNameId+"").after('<p class="text-danger"> Product Name Field is required!! </p>');
			...
			for (var x = 0; x < comment.length; x++) {       			
				...
				if(comment[x].value == ''){	    		    	
					$("#"+commentId+"").after('<p class="text-danger"> Product Name Field is required!! </p>');
			...
			for (var x = 0; x < deliveryDate.length; x++) {       			
				...
				if(deliveryDate[x].value == ''){	    		    	
					$("#"+deliveryDateId+"").after('<p class="text-danger"> Product Name Field is required!! </p>');
