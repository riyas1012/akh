...
@section('content')
    ...
    <div align="center" class="bg1">
        <div class="container">
            ...
            <div class="col-md-12" style="text-align: center;">
                <h3>{{ __('page_labels.application_register') }}</h3>
            </div>
            <div class="card  col-md-5 login-card" style="background-color: transparent !important;">
                <div class="card-body">
                    ...
                    <div id="login" align="center">
                        <form class="form-horizontal" action="{{ route('food.beverage.store') }}" method="post"
                            ...
                            {{-- <fieldset>
                                <div class="row mt-3">
                                    <div class="col-md-12">
                                        <label
                                            class="floating-label label-required">{{ __('page_labels.user_name') }}</label>
                                    ...
                                    <label class="floating-label">
                                        @if (session()->get('locale') == 'en')
                                            <input type="checkbox" name="terms" value="Y"
                                                {{ old('terms') == 'Y' ? 'checked' : '' }}>
                                            {{ __('page_labels.by_submiting_this_form') }}
                                            <a target="_blank"
                            ...
                            <fieldset>
                                <div class="row mt-3">
                                    ...
                                    <button type="submit" class="btn btn-primary"
                                        ...
                                        {{ __('page_labels.register_submit_button') }}</button>

                                </div>
                            </fieldset>
                            {{-- <fieldset>
                                <div class="row mt-3">
                                    <a style="float:right;margin:auto;" href="{{ route('food.beverage') }}"
            ...
            $().ready(function() {
                ...
                $('#registerForm').validate({
                    ...
                    messages: {
                        ...
                        // },
                        // user_name: {
                        //     required: "{{ __('jq_validation.user_name_enter') }}",
                        // },
                        email: {
                        ...
                        terms: {
                            required: "{{ __('jq_validation.terms_condition') }}",
                        }
